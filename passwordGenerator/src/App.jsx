...
function App() {
  ...
  const copyPasswordToClipboard = useCallback(() => {
    ...
    // passwordRef.current?.setSelectionRange(0,3) if you want to select particular range
    ...
    <>
     <div className="w-full max-w-md mx-auto shadow-md rounded-lg px-4 py-3 my-8 text-orange-500 bg-gray-700">
      ...
      <div className="flex text-sm gap-x-2">
        ...
        <div className="flex items-center gap-x-1">
          <input type="checkbox" defaultChecked={numberAllowed} onChange={() => {setNumberAllowed((preValue) => !preValue)}} />
          <label htmlFor="">Numbers</label>
        </div>
        <div className="flex items-center gap-x-1">
          <input type="checkbox" defaultChecked={charAllowed} onChange={()=>{setCharAllowed((preValue) => !preValue )}} />
